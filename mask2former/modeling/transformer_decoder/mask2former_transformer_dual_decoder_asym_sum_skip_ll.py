...
class MultiScaleMaskedDualTransformerDecoder_asymsum_skipll(nn.Module):
    ...
    def forward(self, x, mask_features, mask = None):
        ...
        for i in range(self.num_layers):
            ...
            if i < self.num_layers - 1:
                output_path = output_path + self.query_merging_params_patho[level_index].weight.unsqueeze(1).repeat(1, bs, 1)*output
